...
$routes->group('admin', ['filter' => 'admin'], static function ($routes) {
    ...
    $routes->get('booking/(:num)/receipt', 'Admin\BookingController::receipt/$1');
    $routes->post('booking/(:num)/resend-email-dp', 'Admin\BookingController::resendEmailDp/$1');
    ...
    $routes->post('transaksi/(:num)/resend-email', 'Admin\TransaksiController::resendEmail/$1');
