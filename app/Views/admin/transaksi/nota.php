...
<div class="no-print-actions">
  <button class="btn-salon-primary" style="flex:1;" onclick="window.print()"><i class="bi bi-printer"></i> Print Nota</button>
  <a class="btn-salon-secondary" style="flex:1; text-align:center; display:block; text-decoration:none;" href="<?= base_url('admin/transaksi') ?>"><i class="bi bi-arrow-left"></i> Kembali</a>
</div>
