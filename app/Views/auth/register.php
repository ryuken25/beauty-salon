...
<div class="card-salon">
  ...
  <form method="post" action="<?= base_url('register') ?>">
    ...
    <div class="mb-2">
      ...
      <input class="form-salon-input" type="email" name="email" required value="<?= esc(old('email')) ?>" placeholder="nama@email.com">
    </div>
    <div class="mb-2">
    ...
    <div class="mb-2">
      <label class="form-salon-label">Password (min 6 karakter)</label>
      <input class="form-salon-input" type="password" name="password" required minlength="6">
    </div>
    <div class="mb-2">
      <label class="form-salon-label">Ulangi password</label>
      <input class="form-salon-input" type="password" name="password_confirm" required minlength="6">
    </div>
