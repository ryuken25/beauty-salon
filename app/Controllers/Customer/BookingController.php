    ...
    public function create()
    {
        ...
        if ($this->request->getMethod() === 'POST') {
            ...
            try {
                ...
                return redirect()->to('/pelanggan/booking/' . $id)->with('success', 'Booking berhasil dibuat dan menunggu verifikasi. Hasil verifikasi akan diinformasikan melalui WhatsApp manual oleh admin/pemilik.');
