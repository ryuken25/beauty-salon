...
class BookingModel extends BaseAppModel
{
    ...
    protected $allowedFields = [
        'kode_booking', 'nama_pelanggan', 'nomor_hp_pelanggan', 'email_pelanggan',
        'layanan_id', 'stylist_id',
    ...
    {
        // LEFT join on stylists — pre-2026-05-20 bookings have a null stylist_id.
        return $this->db->table('bookings b')
            ->select('b.*, l.nama AS nama_layanan, l.kategori AS kategori_layanan, l.durasi_menit, l.harga AS harga_layanan_master, l.ikon AS ikon_layanan, s.nama AS nama_stylist, s.spesialisasi AS spesialisasi_stylist')
